...
ec2_sg_ingress = [{rule="ssh-tcp", cidr_blocks="10.10.0.0/16"},
...
#Transit Gateway related specifications
#to update transit gateway route tables
tgw_routes = [{
